    ...
    <div>
      <div className="flex items-end justify-between gap-3 mb-3">
        <div>
          ...
          <p className="text-sm text-cookie-brown/60">모델 파라미터 및 시스템 프롬프트</p>
        </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="mt-2">
                <label className="text-xs text-cookie-brown/60">모델명 직접 입력(선택)</label>
                <input
                  className="input mt-1"
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="text-sm text-cookie-brown/70">Temperature</label>
                <input
                  className="input mt-1"
                  type="number"
                  step="0.1"
              ...
              <div>
                <label className="text-sm text-cookie-brown/70">Top P</label>
                <input
                  className="input mt-1"
                  type="number"
                  step="0.05"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="text-sm text-cookie-brown/70">Presence Penalty</label>
                <input
                  className="input mt-1"
                  type="number"
                  step="0.1"
              ...
              <div>
                <label className="text-sm text-cookie-brown/70">Frequency Penalty</label>
                <input
                  className="input mt-1"
                  type="number"
                  step="0.1"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="text-sm text-cookie-brown/70">Max Tokens</label>
                <input
                  className="input mt-1"
                  type="number"
                  step="100"
            ...
            <div>
              <label className="text-sm text-cookie-brown/70">OpenAI API Key</label>
              <input
                className="input mt-1"
                type="password"
        ...
        <div className="card">
          ...
          <button
            ...
            onClick={() => {
              ...
              setPromptSaved(true);
              if (addLog) addLog("프롬프트 변경", "system_prompt 저장됨");
            }}
          >
            {promptSaved ? "저장됨" : "프롬프트 저장"}
          </button>
        </div>
      </div>
    </div>
